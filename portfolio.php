...
<section id="portfolio" class="portfolio-bg pt-150 loaded">
    <div class="container">
        <div class="banner-content wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
            <div class="row">
                <div class="col-md-9 offset-md-2 position-relative">
                    <div class="line-4 pl-350 sm-pl-150">
                        <h1 class="heading-3">Portfolio</h1>
                    </div>
                </div>
            </div>
        </div>
        <h2 class="fs-55 text-white wow fadeInUp text-center pt-3 fw-600 fs-26m"
            ...
            Peek Into Our <span class="web-color">Projects</span>
        </h2>
        <div class="col-lg-6 offset-lg-3 paragraph">
            <p class="text-white lh-14 text-center wow fadeInUp fs-normal pt-2 fs-14"
                style="visibility: visible; animation-name: fadeInUp;">
                Discover some of our best-delivered projects that brought our clients more cash and loyal customers.
            </p>
        </div>
        <div class="wow fadeInUp text-center md-pt-0 pt-18m" style="visibility: visible; animation-name: fadeInUp;">
