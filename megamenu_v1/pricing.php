...
<section class="pricing-bg pt-150 loaded">
    <div class="container ">
        <div class="banner-content wow fadeInUp">
            <div class="row">
                <div class="col-md-9 offset-md-3 position-relative">
                    <div class="line-3  pl-270 sm-pl-105">
                        <h3 class="heading-3">Pricing</h3>
                    </div>
                </div>
            </div>
        </div>
        <h1 class="fs-55 fw-700 text-white wow fadeInUp text-center pt-3 fs-34m">
            Premium <span class="web-color">Services, <br> Affordable</span> Prices
        </h1>
        <div class="col-lg-6 offset-lg-3">
            <p class="text-white lh-14 text-center wow fadeInUp fs-normal pt-2 fs-14">
                We have designed our pricing points, considering the varying requirements of various
                businesses and
                niches.
            </p>
        </div>
        <div class=" wow fadeInUp text-center md-pt-0 sm-pt-15">
...
<section id="pricing-section" class="pricing-section pt-70 poppins pb-40 sm-pt-40">

    <div class="container text-center">

        <h5 class="heading-4 wow fadeInUp">PREMIUM SERVICES AT AFFORDABLE PRICES</h5>

        <div class="first-heading col-md-12 pt-2 wow fadeInUp">

            <h2 class="fs-40 fw-600 fs-20m">Choose From Our <span class="web-color">Economical Packages</span>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="tab wow fadeInUp" id="tab-active">

                    <div class="row text-center">

                        <div class="col-xl-12">

                            <button class="tab-1 tablinks active" onclick="openCity(event, 'tabs1')">Custom
                            ...
                            <!-- <button class="tab-5 tablinks"

                                                                    onclick="openCity(event, 'tabs5')">SEO</button>

                                                            <button class="tab-6 tablinks"

                                                                    onclick="openCity(event, 'tabs6')">SMM</button>

                                                            <button class="tab-7 tablinks "

                                                                    onclick="openCity(event, 'tabs7')">Web

                                                                    Maintenance</button>

                                                            <button class="tab-8 tablinks"

                                                                    onclick="openCity(event, 'tabs8')">Hosting &

                                                                    Domain</button>

                                                            <button class="tab-9 tablinks"

                                                                    onclick="openCity(event, 'tabs9')">Combo

                                                                    Package</button>

                                                            <button class="tab-10 tablinks"

                                                                    onclick="openCity(event, 'tabs10')">Web Content</button>

                                                            <button class="tab-11 tablinks"

                                                                    onclick="openCity(event, 'tabs11')">Web Portal</button>

                                                            <button class="tab-12 tablinks"

                                                                    onclick="openCity(event, 'tabs12')">Logo Design</button>

                                                            <button class="tab-13 tablinks"

                                                                    onclick="openCity(event, 'tabs13')">Illustration</button>

                                                            <button class="tab-14 tablinks"

                                                                    onclick="openCity(event, 'tabs14')">Branding</button> -->
            ...
            <div id="tabs1" class="tabcontent wow fadeInUp" style="display: block;">

                <section class="pricingrevamp pricing-wrapper">
                    <div class="container">
                    ...
                    <div class="row pr">
                        ...
                        <div class="col-md-4">
                            <div class="t-col-first main">
                                <div class="inner1">
                                    <img class="primg" src="assets/images/pricing/titanium.png">
                                    <h3 class="hsm">Custom E Commerce Marketplace Package</h3>
                                </div>
                                <div class="inner2">
                        ...
                        <div class="col-md-4">
                            <div class="t-col-first main">
                                <div class="inner1">
                                    <img class="primg" src="assets/images/pricing/bronze.png">
                                    <h3 class="hsm">Automated/Interactive E-Commerce Package</h3>
                                </div>
                                <div class="inner2">
                    ...
                    <div class="row pt-130 sm-pt-0">
                        <div class="col-md-4">
                            <div class="t-col-first main">
                                <div class="inner1">
                                    <img class="primg" src="assets/images/pricing/bronze.png">
                                    <h3>Startup WordPress Package</h3>
                                </div>
                                <div class="inner2">
                        ...
                        <div class="col-md-4">
                            <div class="t-col-3 main mp">
                                ...
                                <div class="inner1">
                                    <img class="primg" src="assets/images/pricing/silver.png">
                                    <h3>Professional WordPress Package</h3>
                                </div>
                                <div class="inner2">
                                    <h4>$349 <span>$699.00</span></h4>
                                    <a href="tel:(949) 323-3170" class="brand-black-btn btn-props">Call Now</a>
                    ...
                    <div class="row pr">
                        <div class="col-md-4">
                            <div class="t-col-first main">
                                <div class="inner1">
                                    <img class="primg" src="assets/images/pricing/platinum.png">
                                    <h3>Silver WordPress Package</h3>
                                </div>
                                <div class="inner2">
                        ...
                        <div class="col-md-4">
                            <div class="t-col-first main">
                                <div class="inner1">
                                    <img class="primg" src="assets/images/pricing/titanium.png">
                                    <h3>Business WordPress Package</h3>
                                </div>
                                <div class="inner2">
                            ...
                            <div class="t-col-first main">
                                ...
                                <div class="inner3">
                                    <ul>
                                        ...
                                        <li>Cross Platform Responsive Compatibility (Desktop, iPhone, Android,
                                            etc.)
                                        </li>
                                        <li>Cross Browser Compatibility (Chrome, Firefox, Safari, etc.)</li>
                            ...
                            <div class="t-col-3 main mp">
                                ...
                                <div class="inner3">
                                    <ul>
                                        ...
                                        <li>SEO Friendly Coding (Meta Tags, Meta Titles, Meta Descriptions,
                                            Keywords, W3C Compliant etc.)</li>
                                        ...
                                        <li>Google Friendly Sitemap</li>
                                        <li>Complete Deployment</li>
                                        <li>5 Business Email Addresses</li>
                                        ...
                                        <li>Multi-Currency Support - ($249)</li>
                                    </ul>
                                </div>
                                <div class="inner4">
                                    <p class="p1"><a href="javascript:$zopim.livechat.window.show()">Live
                            ...
                            <div class="t-col-first main">
                                ...
                                <div class="inner3">
                                    <ul>
                                        ...
                                        <li>Content Management System</li>
                                        <li>Sales &amp; Inventory Management</li>
                                        <li>Manage Orders (Track Order, Billing History, Order Status, Automated
                                            Invoicing)</li>
                                        <li>Product Offers (Wish-list, Discount Options, Coupon Codes)</li>
                                        <li>Multiple Product Variations (Color, Size, Quantity, and Other
                                            Attributes)</li>
                                        <li>Intelligent Search System with Filtering Options (Search by Price,
                                            Categories, Styles, etc.)</li>
                                        <li>Product Sorting (Newest, Featured, Popular, Best Seller)</li>
                                        <li>Product Ratings &amp; Reviews</li>
                                        <li>Easy Product Search</li>
                                        <li>Full Shopping Cart Integration</li>
                    ...
                    <div class="row pr">
                        <div class="col-md-4 offset-md-4">
                            <div class="t-col-first main">
                                <div class="inner1">
                                    <img class="primg" src="assets/images/pricing/platinum.png">
                                    <h3>Shopify Enterprise Package</h3>
                                </div>
                                <div class="inner2">
                                ...
                                <div class="inner3">
                                    <ul>
                                        ...
                                        <li>Fast Load Time</li>
                                        <li>Security Plugins</li>
                                        <li>5 Years Free Hosting</li>
                                        <li>5 Years Free Domain Registration</li>
                                        <li>SEO Friendly Coding (Meta Tags, Meta Titles, Meta Description,
                                            Keywords,
                                            etc.)</li>
                                        <li>On-Page SEO Configuration</li>
                                        <li>Google Friendly Sitemap</li>
                                        ...
                                        <li>Unlimited Business Email Addresses</li>
                                        ...
                                        <li>100% Money Back Guarantee</li>
                                        <li>100% Ownership Rights</li>
                                        <li>Professional Content/Copywriting – $1,000 (Up to 20 Pages) – (Per
                                            Page
                                            $50)</li>
    ...
    <div class="price-btn text-center mt-40 wow fadeInUp">

        <a href="javascript:$zopim.livechat.window.show();"><button class="btn bg-button rounded-pill button fs-14">Contact Now
...
<section id="pricing-third" class="pricing-third pt-70 pb-70">
    <div class="container">
        <div class="row">
            <p class="description  wow fadeInUp text-center lh-44 mb-lg-0 mb-sm-0">We understand that <span class="text-white">client
                    requirements</span> vary. </p>
            <p class="description wow fadeInUp text-center lh-44"> Therefore, <span class="text-white">we
                    can
                    create</span> a more
                personalized plan for your business after getting all your <span class="text-white">requirements.</span>
            </p>
        </div>
        <div class="price-btn text-center  wow fadeInUp">
            <a href="contact-us"> <button class="btn text-white price-border rounded-pill padding-set">Contact Us</button></a>
        </div>
...
<section class="bg-color pt-80 pb-80">
    <div class="container">
        ...
        <div class=" text-center pt-20 wow fadeinup">
            <a class="btn consultation mt fs-12m form-3" href="javascript:;" data-bs-toggle="modal" data-bs-target="#contactModal">Book a Call
                &nbsp; </a>
        </div>
    </div>
</section>
