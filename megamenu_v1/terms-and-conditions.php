...
<!-- Home Section Start -->
<section class="terms-and-conditions-bg pt-200 poppins sm-pt-150">
    <div class="container">
        <div class="banner-content">
            <div class="offset-md-3 position-relative wow fadeInUp">
                <div class="lines-terms pl-225 sm-pl-105">
                    <h3 class="heading-3">Dev Pickles</h3>
                </div>
            </div>
            <h1 class="wow fadeInUp text-center heading-7">
                TERMS & <span class="web-color">CONDITIONS</span>
            </h1>
            <div class="col-md-6 offset-md-3 pt-3">
                <p class="text-white lh-14 text-center wow fadeInUp poppins fs-normal fs-14">
                    All dealings with our clients are governed by the following Terms & conditions. Please read them
                    carefully.
                </p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 position-relative">
                <div class=" line-9-new pl-130 sm-pl-90">Last updated 1/4/2025</div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 wow fadeInUp wow fadeInUp ">
                <h2 class="poppins fs-30 fs-22m">AGREEMENT TO<span class="web-color"> TERMS</span></h2>
                <div class="row">

                    <div class="col-sm-12 fs-14 pt-2 sm-p-0">
                        <p>These Terms and Conditions constitute a legally binding agreement
                            made between you, whether
                            personally or on behalf of an entity (“you”) and Dev Pickles LLC. (“we,” “us” or “our”),
                            concerning your access to and use of the hoisolutions.com website as well as any other media
                            form,
                            media channel, mobile website or mobile application related, linked, or otherwise connected
                            thereto
                            (collectively, the “Site”).</p>

                        <p>You agree that by accessing the Site, you have read, understood, and
                            agree to be bound by all of these Terms and Conditions. If you do not agree with all of
                            these Terms and Conditions, then you are expressly prohibited from using the Site and you
                        ...
                        <p>Supplemental terms and conditions or documents that may be posted on
                            the Site from time to time are hereby expressly incorporated herein by reference. We reserve
                            the right, in our sole discretion, to make changes or modifications to these Terms and
                            Conditions at any time and for any reason.</p>
                        <p>It is your responsibility to periodically review these Terms and
                            Conditions to stay informed of updates. You will be subject to, and will be deemed to have
                            been made aware of and to have accepted, the changes in any revised Terms and Conditions by
                        ...
                        <p>Accordingly, those persons who choose to access the Site from other
                            locations do so on their own initiative and are solely responsible for compliance with local
                            laws, if and to the extent local laws are applicable.
                        </p>
                        <p>The Site is intended for users who are at least 18 years old.</p>
                    </div>
                </div>
            </div>

            <div class="col-md-12 wow fadeInUp wow fadeInUp">
                <h3 class="poppins fs-30 fs-22m">INTELLECTUAL<span class="web-color"> PROPERTY RIGHTS</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2 sm-p-0">
                        <p>Unless otherwise indicated, the Site is our proprietary property and
                            ...
                            jurisdictions, and international conventions.</p>
                        <p>The Content and the Marks are provided on the Site “AS IS” for your
                            information and personal use only. Except as expressly provided in these Terms and
                            Conditions, no part of the Site and no Content or Marks may be copied, reproduced,
                        ...
                        <p>Provided that you are eligible to use the Site, you are granted a
                            limited license to access and use the Site and to download or print a copy of any portion of
            ...
            <div class="col-md-12 wow fadeInUp wow fadeInUp">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">USER </span>REPRESENTATIONS</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2 sm-p-0">
                        <p>By using the Site, you represent and warrant that:

                        <div class="fs-14 pt-2 pl-20 pr-20">
                            <p>
                                ...
                                <br>
                                5. you will not access the Site through automated or non-human means, whether through a
            ...
            <!-- <div class="col-md-12 wow fadeInUp ">
                <h2 class="poppins fs-30 fs-22m"><span class="web-color">USER </span>REPRESENTATIONS</h2>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        <p>By using the Site, you represent and warrant that:
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">PROHIBITED </span>ACTIVITIES</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2 sm-p-0">
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">REFUND </span>POLICY</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">

                        <p>Dev Pickles ensure all their client is made satisfied by our work but if you are not
                            satisfied with the initial responses provided by us. Dev Pickles will refund the Initial
                            payments made by you, less a $50.00 service and processing fee.</p>

                        <p>If you have used your credit card for payment means the money will be transferred back to
                            your credit card account. Refunds are usually processed within 14-21business days after your
                            request.</p>

                        <p>Our refunding policy will not take effect under any of the following circumstances.</p>
                        <p>
                            1. The primary design concept (for any service) has been approved.
                            <br>
                            2. You have demanded revisions beyond the initial design concepts (website & mobile app
                            screens).
                            <br>
                            3. The designs (website & mobile app screens) have been finalized.
                            <br>
                            4. The developed product has been designed, developed and deployed live.
                            <br>
                            5. The company has not been contacted for more than 2 weeks without notice.
                            <br>
                            6. If the project placed on hold upon customer request, the refund will be voided.
                            <br>
                            7. Other company or designer has been approached for the same project.
                            <br>
                            8. The creative brief is lacking in required information from the client end.
                            <br>
                            9. A complete design change has been demanded and provided.
                            <br>
                            10. The business is closing or changing name or business.
                            <br>
                            11. Reasons such as ‘change of mind’, ‘disagreement with partner’ or other reasons that do
                            not pertain to the service provided will not be subject to refund under any circumstances.
                            <br>
                            12. Once a client has accepted multiple sets of revisions (for any service), refund will not
                            be applicable.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m">USER GENERATED<span class="web-color"> CONTRIBUTIONS</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">

                        <p>The Site may invite you to chat, contribute to, or participate in blogs, message boards,
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                any manner contemplated by the Site and these Terms and Conditions.
                            </li>
                            <li>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">CONTRIBUTION </span>LICENSE</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        ...
                        <p>This license will apply to any form, media, or technology now known or hereafter developed,
                        ...
                        <p>We do not assert any ownership over your Contributions. You retain full ownership of all of
                            ...
                            in your Contributions provided by you in any area on the Site.</p>
                        <p>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color"></span>SUBMISSIONS</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        ...
                        <p>You hereby waive all moral rights to any such Submissions, and you hereby warrant that any
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">THIRD-PARTY</span> WEBSITES AND CONTENT</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        ...
                        <p>The Site may contain (or you may be sent via the Site) links to other websites (“Third-Party
                            ...
                            or originating from third parties (“Third-Party Content”).</p>

                        <p>Such Third-Party Websites and Third-Party Content are not investigated, monitored, or checked
                            ...
                            in the Third-Party Websites or the Third-Party Content.</p>
                        <p>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m">SITE<span class="web-color"> MANAGEMENT</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m">PRIVACY<span class="web-color"> POLICY</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">

                        <p>We care about data privacy and security. Please review our Privacy Policy
                            https://www.hoisolutions.com/privacy-policy/. By using the Site, you agree to be bound by
                            our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised
                            the Site is hosted in the United States.
                        </p>
                        <p>
                            If you access the Site from the European Union, Asia, or any other region of the world with
                            laws or other requirements governing personal data collection, use, or disclosure that
                            differ from applicable laws in the United States, then through your continued use of the
                            Site, you are transferring your data to the United States, and you expressly consent to have
                            your data.
                        </p>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h2 class="poppins fs-30 fs-22m"><span class="web-color">DIGITAL MILLENNIUM</span> COPYRIGHT
                    ACT<br>(DMCA) NOTICE
                    AND
                    POLICY</h2>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2 sm-p-0">
                        <h3 class="fs-24"><span class="web-color">Notifications</span></h3>
                        ...
                        <ol>
                            <li>identification of the material that has been removed or disabled and the location at
                        ...
                        <h3 class="fs-24"><span class="web-color">Counter Notification</span></h3>
                        ...
                        <p>
                            ...
                            5000 Birch St., West Tower,<br>
                            Suite 3000 Newport Beach, CA 92660<br>
                            info@devpickles.com
                        </p>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">COPYRIGHT </span>INFRINGEMENTS</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        <p>We respect the intellectual property rights of others. If you believe that any material
                            available on or through the Site infringes upon any copyright you own or control, please
                        ...
                        <p>
                            ...
                            make material misrepresentations in a Notification. Thus, if you are not sure that material
                            located on or linked to by the Site infringes your copyright, you should consider first
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m">TERM AND <span class="web-color">TERMINATION</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        <p>These Terms and Conditions shall remain in full force and effect while you use the Site.
                            WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS AND CONDITIONS, WE RESERVE THE RIGHT TO,
                            ...
                            TERMINATE YOUR USE OR PARTICIPATION IN THE SITE OR DELETE YOUR ACCOUNT AND ANY CONTENT OR
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m">MODIFICATIONS AND <span class="web-color">INTERRUPTIONS</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">GOVERNING </span>LAW</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        <p>These Terms and Conditions and your use of the Site are governed by and construed in
                            accordance with the laws of the State of New York applicable to agreements made and to be
                            entirely performed within the State/Commonwealth of New York, without regard to its conflict
                            of law principles.
                        </p>

                        <h3><span class="web-color">DISPUTE RESOLUTION</span></h3>
                        <p><b>Option 1</b></p>

                        <p>
                            Any legal action of whatever nature brought by either you or us (collectively, the “Parties”
                            and individually, a “Party”) shall be commenced or prosecuted in the state and federal
                            courts located in Suffolk County, New York, and the Parties hereby consent to, and waive all
                            defenses of lack of personal jurisdiction and forum non convenience with respect to venue
                            and jurisdiction in such state and federal courts.<br /> Application of the United Nations
                            Convention on Contracts for the International Sale of Goods and the Uniform Computer
                            Information Transaction Act (UCITA) are excluded from these Terms and Conditions. In no
                            event shall any claim, action, or proceeding brought by either Party related in any way to
                            the Site be commenced more than 1 year after the cause of action arose.
                        </p>
                        <p><b>Option 2: Informal Negotiations</b></p>

                        <p>
                            To expedite resolution and control the cost of any dispute, controversy, or claim related to
                            these Terms and Conditions (each a “Dispute” and collectively, the “Disputes”) brought by
                            ...
                            below) informally for at least 360 days before initiating arbitration. Such informal
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">Binding </span>Arbitration</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        ...
                        <p>
                            ...
                            fails to do so. Except where otherwise required by the applicable AAA rules or applicable
                            law, the arbitration will take place in Suffolk County, New York.
                        </p>
                        ...
                        <p>
                            ...
                            commenced or prosecuted in the state and federal courts located in Suffolk County, New York,
                        ...
                        <p>
                            ...
                            commenced more than 1 year after the cause of action arose. If this provision is found to be
                        ...
                        <p><b>Option 3: Binding Arbitration</b></p>

                        <p>To expedite resolution and control the cost of any dispute, controversy or claim related to
                            these Terms and Conditions (each a “Dispute” and collectively, “Disputes”), any Dispute
                            brought by either you or us (individually, a “Party” and collectively, the “Parties”) shall
                            be finally and exclusively resolved by binding arbitration.</p>
                        <p>
                        ...
                        <p>
                            ...
                            arbitration will take place in Suffolk County, New York. Except as otherwise provided
                        ...
                        <p>
                            ...
                            Terms and Conditions. In no event shall any Dispute brought by either Party related in any
                            way to the Site or Services be commenced more than 1 year after the cause of action arose.
                        </p>
                        <p>
                        ...
                        <p><b>Option 2/Option 3: Restrictions</b></p>
                        ...
                        <p><b>Option 2/Option 3: Exceptions to Informal Negotiations and Arbitration</b></p>
                        <p>The Parties agree that the following Disputes are not subject to the above provisions
                            ...
                            invasion of privacy, or unauthorized use; and (c) any claim for injunctive relief.</p>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">CORRECTIONS</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">DISCLAIMER</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">LIMITATIONS </span>OF LIABILITY</h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        ...
                        <p>
                            ...
                            THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE 1 MONTH PERIOD PRIOR TO ANY
                            CAUSE OF ACTION ARISING [OR] $1,000. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">INDEMNIFICATION</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        <p>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates,
                            ...
                            expenses, made by any third party due to or arising out of: (1) your Contributions; (2) use
                            of the Site; (3) breach of these Terms and Conditions; (4) any breach of your
                            ...
                            or (6) any overt harmful act toward any other user of the Site with whom you connected via
                            the Site.
                        </p>
                        <p>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">USER DATA</span></h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        <p>We will maintain certain data that you transmit to the Site for the purpose of managing the
                            ...
                            backups of data, you are solely responsible for all data that you transmit or that relates
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h2 class="poppins fs-35 fs-28m"><span class="web-color">ELECTRONIC </span>COMMUNICATIONS,<br>
                    TRANSACTIONS, AND
                    <span class="web-color">SIGNATURES</span>
                </h2>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">CALIFORNIA</span>USERS AND<br>RESIDENTS
                </h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2 sm-p-0">
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h3 class="poppins fs-30 fs-22m"><span class="web-color">MISCELLANEOUS</span>
                </h3>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2 sm-p-0">
                        ...
                        <p>These Terms and Conditions operate to the fullest extent permissible by law. We may assign
                        ...
                        <p>
                            ...
                            you and us as a result of these Terms and Conditions or use of the Site. You agree that
                            these Terms and Conditions will not be construed against us by virtue of having drafted
                            them.
                        </p>
                        <p>
                            You hereby waive any and all defenses you may have based on the electronic form of these
                            Terms and Conditions and the lack of signing by the parties hereto to execute these Terms
                            and Conditions.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-12 wow fadeInUp ">
                <h2 class="poppins fs-30 fs-22m"><span class="web-color">CONTACT US</span>
                </h2>
                <div class="row">
                    <div class="col-sm-12 fs-14 pt-2      sm-p-0">
                        ...
                        <p>
                            <br>5000 Birch St.,
                            <br>West Tower,
                            <br>Suite 3000 Newport Beach,
                            <br>CA 92660
                        </p>
                        <a href="tel:949-267-7994" class="text-black">USA: 949-267-7994</a>
                        <br>
                        <a href="mailto:info@devpickles.com" class="mail">info@devpickles.com</a>
                    </div>
                </div>
            </div>
        </div>
