...
<section class="p3-fullstack-website-bg pt-150 pb-70">
    <div class="container">
        <div class="row">
            <div class="">
                <div class="banner-content">
                    <div class="row wow fadeInUp offset-md-4">
                ...
                <div class="col-md-7 offset-md-3">
                    <h2 class="fs-40 fs-25m fw-600 wow fadeInUp text-center pt-3 text-white">
                        <span class="web-color">Full Stack </span>Development
                    </h2>
                </div>
            </div>
        </div>
...
<section class="pt-50">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h1 class="fw-600 poppins fs-36 fs-20m wow fadeInUp">Leading <span class="web-color">Full Stack
                        Development </span>Services
                </h1>

                <p class="pt-4 fs-14m wow fadeInUp">
                    Dev Pickles is a leading full stack development company helping startups to enterprise-grade
                    corporations meet their business goals with websites, apps and custom software programs.
                    <br><br>
                    Our team of full-stack developers is an expert with 10+ years of experience in full stack web
                    development services: from the front and back end to database management.
                </p>
...
<!-- THIRD SECTION START  -->
<section class="page-spacing-topnull sm-pt-40">
    <div class="container">
        <div class="row">
        ...
        <div class="row align-items-center p3-custom-paragraph">
            <div class="col-md-6 pt-2 wow slideInLeft">
                <h2 class="text-black first text-capitalize">
                    Custom <span class="web-color">Full Stack Web Development
                    </span>For
                    All Businesses</h2>
            ...
            <div class="col-md-6 wow slideInRight sm-pt-20">
                <p class="text-black second">
                    At Dev Pickles, we only believe in delivering the most scalable web solutions for our clients. We
                    have experience with clients from around the globe. Whether you need custom web solutions for B2B,
                    technology, startups, or e-commerce, we have the expertise to grow your business.
                </p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <h2 class="text-white first fs-30 pt-10 text-capitalize fs-22m">Delivering <span class="web-color">Full
                        Stack
                        solutions </span>with modern tech
                </h2>
                <p class="fs-14 text-white">
                    We have witnessed our clients gain competitive advantage while leveraging the most contemporary
                    technologies known to science. We develop websites with capabilities of Artificial Intelligence and
                    Machine Learning, Internet of Things, Augmented and Virtual Reality.
                    <br>Want more advanced integrations for your website?
                </p>
                <!-- <p class="text-white">Want more advanced integrations for your website?</p> -->
                <div class="wow fadeInUp p3-first-button">
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/angular.png" alt="Angular Development"
                                title="Dev PicklesSolution WordPress Angular Png">
                        </div>
                    </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/react.png" alt="React Development"
                                title="Dev PicklesSolution WordPress React Png">
                        </div>
                    </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/java.png" alt="Java Development"
                                title="Dev PicklesSolution WordPress Java Png">
                        </div>
                    </div>
                    <div class="col-md-3 col-xs-6">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/flutter.png" alt="Flutter Development"
                                title="Dev PicklesSolution WordPress Flutter Png">
                        </div>
                    </div>
                </div>
                <div class="row pt-30">
                    <div class="col-md-3">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/python.png" alt="Python Development"
                                title="Dev PicklesSolution WordPress Python Png">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/net.png" alt=".Net Development"
                                title="Dev PicklesSolution WordPress .Net Png">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/node.png" alt="Nod Js Development"
                                title="Dev PicklesSolution WordPress Nod Js Png">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="p3-box-color">
                            <img src="assets/images/p3-full-stack/php.png" alt="Php Development"
                                title="Dev PicklesSolution WordPress Php Png">
                        </div>
                    </div>
                </div>
...
<section class="p3-full-stack-bg2">
    <div class="container">
        <div class="row pt-120 sm-pt-20 banner-third">
            <div class="col-md-5">
                <!-- <div class="p3-fourth-line position-relative wow fadeInUp">
                    Lorem ipsum
                </div> -->
                <h2 class="wow fadeInUp fs-30 fs-20m">Why Hire A <span class="text-black">Full Stack Developer
                    </span>From Dev Pickles?</h2>

                <p class="para-long wow fadeInUp">
                    Dev Pickles has a team of experienced website designers and developers. Your website should
                    deliver an impeccable visual experience for the users. Our full stack developers know exactly what
                    will resonate with your users. We go through an extensive process to help you meet those user
                    demands.
                </p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6  wow slideInLeft">
                <p class="second">
                    Dev Picklesleverages its technology expertise when working in full stack web development: ranging from API
                    and Middleware integration to DevOps and more. Here are some of the full-stack development services
                    we offer:
                </p>
            </div>
            <div class="col-md-6">
                <div class="position-relative wow slideInRight">
                    <div class="p3-third-line pl-120 sm-pl-70 ">End-To-End Proficiency</div>
                </div>
                <div class=" web-paragraph-2">
                    <div class=" pt-2 wow slideInRight">
                        <h2 class="text-black first">
                        Our Comprehensive <span class="web-color">Full Stack Web Development </span>Services
                        </h2>
...
<section class="p3-full-stack-bg3">
    <div class="container">
        <div class="row banner-third page-spacing-bottomnull">
            <div class="col-md-6 offset-md-6">
                ...
                <div class="row pt-20 sm-pt-0">
                    ...
                    <div class="col-md-11">
                        <p class="fs-16 fs-14mm text-white">
                            Web development solutions for businesses of different sizes, verticals, and industries.
                        </p>
                    </div>
                </div>
                <div class="row pt-20 sm-pt-5">
                    ...
                    <div class="col-md-11">
                        <p class="fs-16 fs-14mm text-white">
                            A dedicated team of experts for integrating your CRM, marketing automation, web interfaces,
                            and more.
                        </p>
                    </div>
                </div>
                <div class="row pt-20 sm-pt-5">
                    ...
                    <div class="col-md-11">
                        <p class="fs-16 fs-14mm text-white">
                            After-service support through regular maintenance, patch fixes, and new features.
                        </p>
                    </div>
                </div>
                <div class="pt-10 sm-pt-30 wow fadeInUp">
                    <a class="btn web-btn consultation hover get-in-app-development form-3" href="javascript:;"
                        data-bs-toggle="modal" data-bs-target="#contactModal">Book a
                        Consultation&nbsp; </a>
                </div>
            </div>
        </div>
...
<section class="page-spacing">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 wow slideInLeft">
                <p class="lh-24 fs-14m pt-20 sm-pt-20">
                    We have a proven and repeatable work process that helps us deliver you value in the shortest time.
                </p>
            </div>
            <div class="col-md-5 offset-md-1 wow slideInRight">
                <h2 class="fs-30 fs-20m">Here’s how our <span class="web-color">Full Stack </span>web development
                    process works
                </h2>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row pt-40 sm-pt-0 counters">
            <div class="col-md-4 counter-1-stack wow fadeinup">
                ...
                <h3 class=" web-color d-inline-block">Discovery</h3>
                <p class="pl-75 pt-25 lh-20 sm-pl-72 sm-pt-15 fs-14">
                    This is an in-depth project audit where we identify business cases and perform documentation
                    reviews.
                </p>
            </div>

            <div class="col-md-4 counter-2-stack wow fadeinup">
                ...
                <p class="pl-80 pt-25 lh-20 sm-pl-72 sm-pt-15 fs-14">
                    Here we plan a strategy and action roadmap for the full-stack development of your digital product.
                </p>
            </div>

            <div class="col-md-4 counter-3-stack wow fadeinup">
                ...
                <h3 class=" web-color d-inline-block">Execution</h3>
                <p class="pl-80 pt-25 lh-20 sm-pl-72 sm-pt-15 fs-14">
                    In this stage, we design the website’s UI and UX, then code the website’s front and back end, and
                    integrate APIs.
                </p>
            </div>
        </div>
        <div class="row counters pt-50 sm-pt-0 wow fadeinup">
            <div class=" offset-md-2 col-md-4 counter-4-stack">
                ...
                <h3 class=" web-color d-inline-block">Test and QA</h3>
                <p class="pl-96 pt-25 lh-20 sm-pl-72 sm-pt-15 fs-14">
                    This is the QA stage where we battle-test the performance, functionality, features and loading speed
                    of the website.
                </p>

            </div>

            <div class="col-md-4 counter-5-stack wow fadeinup">
                ...
                <h3 class=" web-color d-inline-block">Web launch</h3>

                <p class="pl-90 pt-25 lh-20 sm-pl-72 sm-pt-15 fs-14">
                    After quality checks, your website goes live on search engines. The first step
                    <span id="dots-5">...</span><span id="more-5">
                        to establishing your
                        digital presence gets complete here!
                    </span>
                </p>
    ...
    <div class="container">
        <div class="row pt-2">
            <div class="col-md-6 wow fadeinup">
                <h2 class="line-before fs-18m lh-40 web-color fs-28">Grow Your Business With Our <span
                        class="text-white">Full-Stack Web Development </span>Company</h2>
            </div>
        </div>
        <div class="row pt-2 ">
            <div class="col-md-10 wow fadeInUp text-white">
                <p class="fs-normal color-grey fs-14m">
                    Our client-centric approach and the experience of our professional full stack developers have made
                    us a leading full stack development company globally.
                </p>
            </div>
        </div>
        <div class="row counters-md pt-40">
            <div class="col-md-3 counter-1-branding wow fadeInUp">
                ...
                <div></div>
                <h3 class=" text-white fs-20 fs-20m pt-10 text-center">Front-End Development</h3>
                <p class="text-white fs-14 text-center">
                    Our full-stack developers are experts in front-end languages such as Mocha, CSS/SCSS, Bootstrap,
                    JavaScript, Angular.Js, Node.js, and React.Js.
                </p>
            </div>
            <div class="col-md-3 sm-pt-20 counter-2-branding wow fadeInUp">
                ...
                <div></div>
                <h3 class=" text-white fs-20 fs-20m pt-10 text-center">Back-End Development</h3>
                <p class="text-white fs-14 text-center">
                    Our developers use programming languages and frameworks like Python, SQL, and Laravel for back-end
                    development.
                </p>
            </div>
            <div class="col-md-3 sm-pt-20 counter-3 wow fadeInUp">
                ...
                <div></div>
                <h3 class="text-white fs-20 fs-20m pt-10 text-center ">Database Configuration</h3>
                <p class="text-white fs-14 text-center">
                    Our Full Stack developers collect crucial insights from huge amounts of data with XML/JSON.
                </p>
            </div>
            <div class="col-md-3 sm-pt-20 counter-4-branding wow fadeInUp">
                ...
                <div></div>
                <h3 class=" text-white fs-20 fs-20m pt-10 text-center">API Integration</h3>
                <p class=" text-white fs-14 text-center">
                    Our experts execute custom web API and integration services for your payment systems, social
                    networks, business tools, etc.
                </p>
            </div>
        </div>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            ...
                            <div class="accordion-body">
                                We build diverse websites from basic blogs and community forums to high-end web
                                applications and e-commerce stores. We have built websites for different industries
                                ranging from real estate to brokerage firms. We are always researching the most advanced
                                tech that can embed every functionality in your website.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingFour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                What is the difference between full-stack development and generic website development?
                            </button>
                        </h3>
                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                A website developed by a full stack is much faster than a generic website. It also
                                minimizes the cost of developing a website by reducing the maintenance and testing costs
                                by a huge margin.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                The cost of developing a full stack website depends on a couple of factors. The number
                                of pages, the number of users, and the development technology all of these factors
                                contribute to the overall pricing. Before we start working, we first analyze the
                                technology stack you’ll need, and then we move ahead with an estimated quote.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingEight">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Does your full stack web development company offer after-delivery support?
                            </button>
                        </h3>
                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Absolutely, we stay by your side every step of the way! You’ll get complete
                                after-delivery support which includes patch fixes, new enhancement features,
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                We always believe in complete transparency throughout the process. You’ll have a
                                dedicated team member who will regularly update you on all the project developments.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h3 class="accordion-header" id="headingTen">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Why do you choose full stack web development services for your projects?
                            </button>
                        </h3>
                        <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Full stack developers have a solid grip on different web development technologies such
                                as creating the backend database, front-end designing, and much more. So, if you want a
                                more seamless and high-tech website, you should definitely be a full stack development
                                company.
                            </div>
                        </div>
                    </div>
