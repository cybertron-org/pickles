...
<head>
    ...
    <script>
        gtag('event', 'conversion', {
            'send_to': 'AW-11172097351/K70OCMazrd8YEMfaos8p'
        });
    </script>
    ...
    <script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=d4ed3c49-3369-4481-9256-03ffbe590dfe"></script>
    <script>
        zE(function() {
            $zopim(function() {
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-1">
                            <div class="logo-part">
                                <a href="/">
                                    <img class="normal-logo" src="assets/images/logo.png" alt="Dev Pickles" title="Dev PicklesSolution">
                                    <img class="sticky-logo" src="assets/images/logo.png" alt="Dev Pickles" title="Dev PicklesSolution">
                                </a>
                            </div>
                            ...
                            <div class="wsmobileheader clearfix">
                                ...
                                <span class="smllogo"><img src="assets/images/logo.png" width="80" alt="" /></span>
                        ...
                        <div class="col-lg-6 pl-21 sm-pl-10">
                            <div class="headerfull">
                                <div class="wsmain clearfix">
                                    <div class="smllogo">
                                        <a href="#"><img src="images/sml-logo.png" alt="" /></a>
                                    </div>
                                    <nav class="wsmenu clearfix">
                                        <ul class="wsmenu-list">

                                            <li aria-haspopup="true"><a href="#" class="navtext"> Home</a> </li>

                                            <li aria-haspopup="true"><a href="#" class="navtext"> About Us</a> </li>
                                                ...
                                                <div class="wsshoptabing wtsdepartmentmenu clearfix">
                                                    <div class="wsshopwp clearfix">
                                                        <ul class="wstabitem clearfix">
                                                            ...
                                                            <li class="wsshoplink-active"><a href="website-design-and-development">Website Design and Development</a>
                                                                <div class="wstitemright clearfix wstitemrightactive">
                                                                    <div class="container-fluid">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-12 white-bg">
                                                                                <ul class="wstliststy02 clearfix active-color">
                                                                                    <li><a href="custom-website-design-and-development"><span class="menu_icons"><img src="assets/images/mega-menu/wdd.png"></span><span> Custom Website Design and Development</span> </a></li>
                                                                                    <li><a href="full-stack-development"><span class="menu_icons"><img src="assets/images/mega-menu/full-stack.png"></span><span> Full Stack Development </span></a></li>
                                                                                    <li><a href="shopify-website-development"><span class="menu_icons"><img src="assets/images/mega-menu/shopify.png"></span> <span>Shopify Website Development </span></a></li>
                                                                                    <li><a href="ecommerce-website-development"><span class="menu_icons"><img src="assets/images/mega-menu/e-commerce.png"></span><span> eCommerce Website Development </span></a></li>
                                                                                    <li><a href="wordpress-design-and-development"><span class="menu_icons"><img src="assets/images/mega-menu/wordpress.png"></span><span>WordPress design and development</span> </a></li>
                                                                                    <li><a href="website-maintenance "><span class="menu_icons"><img src="assets/images/mega-menu/maintainance.png"></span> <span>Website Maintenance</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-12 gree-bg">
                                                                                <div class="para">
                                                                                    <p>Learn about the transport situation and how its dominated by on demand and ride sharing products like eScooters</p><a href="#">Download E-book</a>
                                                                                    <p></p>
                                                                                </div>
                                                                                <div class="imgpara"><img src="assets/images/mega-menu/notebook.png"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <li><a href="mobile-app-development">Mobile Application Development</a>
                                                                <div class="wstitemright clearfix ">
                                                                    <div class="container-fluid">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-12 white-bg">
                                                                                <ul class="wstliststy02 clearfix active-color">
                                                                                    <li><a href="ios-app-development"><span class="menu_icons"><img src="assets/images/mega-menu/ios.png"></span> <span>iOS App Development </span></a></li>
                                                                                    <li><a href="android-app-development"><span class="menu_icons"><img src="assets/images/mega-menu/android.png"></span> <span>Android App Development </span></a></li>
                                                                                    <li><a href="cross-platform-app-development"><span class="menu_icons"><img src="assets/images/mega-menu/cross-app.png"></span> <span>Cross-App Development</span> </a></li>
                                                                ...
                                                                <div class="wstitemright clearfix ">
                                                                    <div class="container-fluid">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-12 white-bg">
                                                                                <ul class="wstliststy02 clearfix active-color">
                                                                                    <li><a href="crm-web-portal"><span class="menu_icons"><img src="assets/images/mega-menu/CRM.png"></span><span>CRM Web Portal</span>  </a></li>
                                                                                    <li><a href="b2b-and-b2c-web-portals"><span class="menu_icons"><img src="assets/images/mega-menu/b2b-b2c.png"></span> <span>B2B and B2C Web Portals </span></a></li>
                                                                                    <li><a href="python-development"><span class="menu_icons"><img src="assets/images/mega-menu/python.png"></span> <span>Python Development</span> </a></li>
                                                                                    <!-- <li><a href="custom-software-development"><span class="menu_icons"><img src="assets/images/mega-menu/ios.png"></span><span> iOS App Development</span> </a></li> -->
                                                                                    <li><a href="custom-software-development"><span class="menu_icons"><img src="assets/images/mega-menu/custom-software-development.png"></span> <span>Custom Software Development </span></a></li>
                                                                                    <li><a href="react-native-development"><span class="menu_icons"><img src="assets/images/mega-menu/react.png"></span><span> React Native Development</span> </a></li>
                                                                                    <li><a href="saas-development"><span class="menu_icons"><img src="assets/images/mega-menu/SaaS.png"></span> <span>SaaS Development</span> </a></li>
                                                                                    <li><a href="magento-development"><span class="menu_icons"><img src="assets/images/mega-menu/Magento.png"></span> <span>Magento Development </span></a></li>
                                                            ...
                                                            <li><a href="blockchain-development">Blockchain Development</a>
                                                                <div class="wstitemright clearfix ">
                                                                    <div class="container-fluid">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-12 white-bg">
                                                                                <ul class="wstliststy02 clearfix active-color">
                                                                                    <li><a href="dapp-development"><span class="menu_icons"><img src="assets/images/mega-menu/dAPP.png"></span> <span>dApp Development </span></a></li>
                                                                                    <li><a href="nft-marketplace-development"><span class="menu_icons"><img src="assets/images/mega-menu/NFT.png"></span><span> NFT Marketplace </span></a></li>
                                                                                    <li><a href="nft-consulting-services"><span class="menu_icons"><img src="assets/images/mega-menu/NFTC.png"></span><span> NFT Consulting Services </span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-12 gree-bg">
                                                                                <div class="para">
                                                            ...
                                                            <li aria-haspopup="true"><a href="game-development" class="navtext_no_sub_menu"> Game Development</a>
                                                                ...
                                                                <div class="wstitemright clearfix ">
                                                                    <div class="container-fluid">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-12 white-bg">
                                                                                <ul class="wstliststy02 clearfix active-color">
                                                                                    <!-- <li><a href="#"><span class="menu_icons"></span> <span></span></a></li>
                          <li><a href="#"><span class="menu_icons"></span><span></span></a></li>
                          <li><a href="#"><span class="menu_icons"></span><span></span></a></li>                             -->
                                                                                </ul>
                                                                            </div>
                                            ...
                                            <li aria-haspopup="true"><a href="#" class="navtext"> Portfolio</a> </li>

                                            <li aria-haspopup="true">
                                                <a href="#" class="navtext"> <span>Location</span></a>
                                            ...
                                            <li aria-haspopup="true">
                                                <a href="#" class="navtext"> <span>Industries</span></a>
                                                <div class="wsshoptabing not_fullwidth wtsdepartmentmenu clearfix">
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col">
                                                                <ul class="wstliststy06 clearfix">
                                                                    <li><a href="#">Automotive Services Web Development</a></li>
                                                                    <li><a href="#">Real Estate Services Web Development</a></li>
                                                                    <li><a href="#">Financial Services Web Development</a></li>
                                                                    <li><a href="#">Healthcare Services Web Development</a></li>
                                                                    <li><a href="#">Law Services Web Development</a></li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <li aria-haspopup="true"><a href="#" class="navtext"> Blog</a> </li>
                        ...
                        <div class="col-lg-2 call hidden-sm hidden-tb">
                            <a href="tel:<?php echo $phone_number ?>" onclick="gtag_report_conversion();" class="number pl-30">
