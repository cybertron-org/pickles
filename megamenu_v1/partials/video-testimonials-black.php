        ...
        <div class="container">
            <div class="row">
                <div class="slider-top">
                    ...
                    <p><img class="mobile-hide" src="assets/images/slider/pseudo.png" alt="Line" title="Dev Pickles Line Section Png">&nbsp;&nbsp;What do Real customer
                        have to say
                        about us&nbsp;&nbsp;<img class="mobile-hide" src="assets/images/slider/pseudo.png" alt="Line" title="Dev Pickles Line Section Png">
                    </p>
                </div>
