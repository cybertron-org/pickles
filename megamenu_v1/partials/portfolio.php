    ...
    <div class="container">
        ...
        <div class="row wow fadeInDown">
            <div class="col-md-6 offset-md-3 text-center">
                <h2 class="pt-20 pb-20 fs-20m">We bring our <span class="web-color">clients’ visions</span>
                    to digital
                    reality.
                </h2>
            </div>
        ...
        <div class="portfolio-menu mt-2 mb-4">
            <nav class="controls">
                <button type="button" class="control outline mixitup-control-active" data-filter=".automotive">
                    Automotive</button>
                <button type="button" class="control outline" data-filter=".realestate">Real Estate</button>
                <button type="button" class="control outline" data-filter=".financial">Financial</button>
                <button type="button" class="control outline" data-filter=".healthcare">healthcare</button>
                <button type="button" class="control outline" data-filter=".law">law</button>
            </nav>
        </div>
        <ul class="row portfolio-index-item" id="MixItUp14DDBD">
            ...
            <li class="mix automotive col-xl-4 col-md-4 col-12 col-sm-6">
                <img class="lazy" src="assets/images/nportfolio/automotive/1.png" itemprop="thumbnail" alt="Dev Pickles Automotive Portfolio Dealer Geek"	title="Dev Pickles Automotive Portfolio Dealer Geek Png">
            ...
            <li class="mix automotive col-xl-4 col-md-4 col-12 col-sm-6">
                <img class="lazy" src="assets/images/nportfolio/automotive/2.png" itemprop="thumbnail"
                    alt="Dev Pickles Automotive Portfolio Zen Auto" title="Dev Pickles Automotive Portfolio Zen Auto Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix automotive col-xl-4 col-md-4 col-12 col-sm-6">
                <img class="lazy" src="assets/images/nportfolio/automotive/3.png" itemprop="thumbnail"
                    alt="Dev Pickles Automotive Portfolio Sream Car Giveaways" title="Dev Pickles Automotive Portfolio Sream Car Giveaways Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix automotive col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/automotive/view4.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix automotive col-xl-4 col-md-4 col-12 col-sm-6">
                <img class="lazy" src="assets/images/nportfolio/automotive/5.png" itemprop="thumbnail"
                    alt="Dev Pickles Automotive Portfolio Redcarpet Auto Loans" title="Dev Pickles Automotive Portfolio Redcarpet Auto Loans Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/automotive/view5.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix automotive col-xl-4 col-md-4 col-12 col-sm-6">
                <img class="lazy" src="assets/images/nportfolio/automotive/7.png" itemprop="thumbnail"
                    alt="Dev Pickles Automotive Portfolio ABC Breaks" title="Dev Pickles Automotive Portfolio ABC Breaks Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix automotive col-xl-4 col-md-4 col-12 col-sm-6">
                <img class="lazy" src="assets/images/nportfolio/automotive/8.png" itemprop="thumbnail"
                    alt="Dev Pickles Automotive Portfolio Quest Overland" title="Dev Pickles Automotive Portfolio Quest Overland Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/automotive/view8.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix realestate col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/realestate/1.png" itemprop="thumbnail"
                    alt="Dev Pickles Real Estate Portfolio My Place"	title="Dev Pickles Real Estate Portfolio My Place Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/realestate/view1.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix realestate col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/realestate/2.png" itemprop="thumbnail"
                    alt="Dev Pickles Real Estate Portfolio Dreamrent"	title="Dev Pickles Real Estate Portfolio Dreamrent Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/realestate/view2.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix realestate col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/realestate/3.png" itemprop="thumbnail"
                    alt="Dev Pickles Real Estate Portfolio Sil.Ent" title="Dev Pickles Real Estate Portfolio Sil.Ent Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix realestate col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/realestate/view4.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix realestate col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/realestate/view6.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix realestate col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/realestate/9.png" itemprop="thumbnail"
                    alt="Dev Pickles Real Estate Portfolio Goodliving" title="Dev Pickles Real Estate Portfolio Goodliving Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/realestate/view9.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix financial col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/financial/3.png" itemprop="thumbnail"
                    alt="Dev Pickles Financial Portfolio Finanzero" title="Dev Pickles Financial Portfolio Finanzero Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/financial/view3.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix financial col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/financial/view5.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix financial col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/financial/6.png" itemprop="thumbnail"
                    alt="Dev Pickles Financial Portfolio Movement Mortgage" title="Dev Pickles Financial Portfolio Movement Mortgage Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix healthcare col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/healthcare/1.png" itemprop="thumbnail"
                    alt="Dev Pickles Healthcare Portfolio Health Care" title="Dev Pickles Healthcare Portfolio Health Care Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix healthcare col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/healthcare/3.png" itemprop="thumbnail"
                    alt="Dev Pickles Healthcare Portfolio Dental Care"  title="Dev Pickles Healthcare Portfolio Dental Care Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix healthcare col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
                            href="assets/images/nportfolio/healthcare/view4.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix healthcare col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/healthcare/5.png" itemprop="thumbnail"
                    alt="Dev Pickles Healthcare Portfolio Loka Health"  title="Dev Pickles Healthcare Portfolio Loka Health Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix healthcare col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/healthcare/7.png" itemprop="thumbnail"
                    alt="Dev Pickles Healthcare Portfolio All Spices"  title="Dev Pickles Healthcare Portfolio All Spices Png" >
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix healthcare col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/healthcare/8.png" itemprop="thumbnail"
                    alt="Dev Pickles Healthcare Portfolio NextDoor"  title="Dev Pickles Healthcare Portfolio NextDoor Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in"
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/1.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Robinson & Associates"  title="Dev Pickles Law Portfolio Robinson & Associates Png" >
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/2.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Bith Injury & Medical Malpractice"  title="Dev Pickles Law Portfolio Bith Injury & Medical Malpractice Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/3.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Sadek & Cooper"  title="Dev Pickles Law Portfolio Sadek & Cooper Png" >
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/4.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio H. Ernest Stone"  title="Dev Pickles Law Portfolio H. Ernest Stone Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/5.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Hatefield"  title="Dev Pickles Law Portfolio Hatefield Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/6.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Construction Law Attorneys"  title="Dev Pickles Law Portfolio Construction Law Attorneys Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/7.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Oakwood Legal Group"  title="Dev Pickles Law Portfolio Oakwood Legal Group Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/nportfolio/law/view7.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/8.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Legal Trend"  title="Dev Pickles Law Portfolio Legal Trend Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
            ...
            <li class="mix law col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                <img class="lazy" src="assets/images/nportfolio/law/9.png" itemprop="thumbnail" alt="Dev Pickles Law Portfolio Karen L. Goldstien"  title="Dev Pickles Law Portfolio Karen L. Goldstien Png">
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/nportfolio/law/view9.png">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
