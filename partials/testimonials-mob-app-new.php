<div class="testimonials2 page-spacing">
    <div class="container">
        <div class="row">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="picture-hover">
                                <div class="card9">
                                    <div class="picture">
                                        <img src="assets/images/testimonials/mobapp-1.png" alt="Dev Pickles Review Liam Smith" title="Dev Pickles Review Client Liam Smith" 
                                            class="img-fluid rounded-circle">
                                    </div>
                                    <p class="lh-lg">
                                        I own a travel agency and I wanted an app where users would receive offers, read
                                        content about travel and tourism, and make bookings. Overall, I wanted an app
                                        that would provide a great user experience to tourists and
                                        travelers. That is when I came across Dev Pickles and connected with them
                                        through a
                                        call. They were more enthusiastic about my app’s success than I was. We
                                        created app screen designs together, kicked off in the second week and started
                                        development.
                                    </p>
                        ...
                        <div class="swiper-slide">
                            <div class="picture-hover">
                                <div class="card9">
                                    <div class="picture">
                                        <img src="assets/images/testimonials/mobapp-2.png" alt="Dev Pickles Review Noah Johnson" title="Dev Pickles Review Client Noah Johnson" 
                                            class="img-fluid rounded-circle">
                                    </div>
                                    <p class="lh-lg">
                                        I run a skincare brand so I wanted an app where users could order products from
                                        my skincare line. I wanted a speedy and buyer-friendly app. When I checked their
                                        reviews on Clutch, I decided to schedule a discovery call. Thankfully, they
                                        turned out to be wonderful, their service was great, and I can't wait to collab
                        ...
                        <div class="swiper-slide">
                            <div class="picture-hover">
                                <div class="card9">
                                    <div class="picture">
                                        <img src="assets/images/testimonials/mobapp-3.png" alt="Dev Pickles Review Oliver Williams" title="Dev Pickles Review Client Oliver Williams" 
                                            class="img-fluid rounded-circle">
                                    </div>
                                    <p class="lh-lg">
                                        We hired Dev Pickles for developing a small-scale mobile app for our cakes
                                        business. We are basically a very small bakery in Princeton and recently started
                                        selling customized cakes. We had some inbound leads from our B2C website, and
                                        wanted to scale with an app that would help our users book and pay online. The
                                        design and development experience has been good with HOI. We can say that
                                        because visitors haven’t had any problems in booking so far.
                                    </p>
                                    <div class="card-title">
                                        <img class="card-quote" src="assets/images/testimonials/quote-up.svg" alt="Card Image Cap" title="Dev PicklesSolution Reviews Card Image Cap">
                                    </div>
