        ...
        <ul class="row portfolio-index-item" id="MixItUp14DDBD">
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-1.webp">
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-2.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-3.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-4.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-5.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-6.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-7.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-8.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix web-app col-xl-4 col-md-4 col-12 col-sm-6">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-9.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix mobile-app col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-a1.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix mobile-app col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-a2.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix mobile-app col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-a3.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix mobile-app col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-a4.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix mobile-app col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-a5.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
            ...
            <li class="mix mobile-app col-xl-4 col-md-4 col-12 col-sm-6" style="display: none;">
                ...
                <div class="portfolio-index-overlay">
                    <div class="overlay-content">
                        <p class="category"></p>
                        <a data-fancybox="item" title="click to zoom-in" href="assets/images/mockup/mockup-a6.webp">
                            <div class="magnify-icon">
                                <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                            </div>
                        </a>
