<section class="pricingrevamp pricing-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <div class="outer1">
                    ...
                    <p>We have designed our pricing points, considering the varying requirements of various businesses
                        and niches.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="mySwiper mySwipermain-wrapper">
                    <div class="swiper-wrapper mySwiper_pricing">
                        <div class="swiper-wrapper">
                            <div
                                class="swiper-slide _active_col_show first_active_col without_slide_col cursor-grab z-60">
                                <div class="t-col-first t-col-transition">
                                    <div class="inner1">
                                        <h2>Startup WordPress Package</h2>
                                    </div>
                                    <div class="inner2">
                                        <h2>$249 <span>$399.00</span></h2>
                                        <button class="btns" href="javascript:;" data-bs-toggle="modal" data-bs-target="#contactModal">View Detail</button>
                                    </div>
                                    <div class="inner3">
                                        <ul>
                                    ...
                                    <div class="inner4">
                                        <p class="p1"><a href="javascript:$zopim.livechat.window.show()">Live Chat</a>
                                        </p>
                                        <p class="p2"><a href="mailto:info@devpickles.com">info@devpickles.com</a>
                                        </p>
                                        <p class="p3"><a href="tel:(949) 323-3170">(949) 323-3170</a></p>
                                        <button class="btns" href="javascript:;" data-bs-toggle="modal" data-bs-target="#contactModal">Get A Quote</button>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide swiper-slide-next active_col_show z-50">
                                <div class="t-col-1 t-col-transition">
                                    <div class="inner1">
                                        <h2>Business WordPress Package</h2>
                                    </div>
                                    <div class="inner2">
                                        <h2>$1949 <span>$3199.00</span></h2>
                                        <button class="btns" href="javascript:;" data-bs-toggle="modal" data-bs-target="#contactModal">View Detail</button>
                                    </div>
                                    <div class="inner3">
                                        <ul>
                            ...
                            <div class="swiper-slide active_col_show active_col_show_1 z-40">
                                <div class="t-col-2 t-col-transition">
                                    <div class="inner1">
                                        <h2 class="fs-14i">Automated/Interactive Conferencing Portal</h2>
                                    </div>
                                    <div class="inner2">
                                        <h2>$1949 <span>$3199.00</span></h2>
                                        <button class="btns" href="javascript:;" data-bs-toggle="modal" data-bs-target="#contactModal">View Detail</button>
                            ...
                            <div class="swiper-slide without_slide_col active_col_show_2 z-30">
                                <div class="t-col-3 t-col-transition">
                                    <div class="inner1">
                                        <h2 class="fs-14i">Professional WordPress Package</h2>
                                    </div>
                                    <div class="inner2">
                            ...
                            <div class="swiper-slide without_slide_col z-20">
                                <div class="t-col-all t-col-transition">
                                    <div class="inner1">
                                        <h2>Elite WordPress Package</h2>
                                    </div>
                                    <div class="inner2">
                                        <h2>$599 <span>$1199.00</span></h2>
                                        <button class="btns" href="javascript:;" data-bs-toggle="modal" data-bs-target="#contactModal">View Detail</button>
                                    </div>
                                    <div class="inner3">
                                        <ul>
                            ...
                            <div class="swiper-slide without_slide_col z-10">
                                <div class="t-col-all t-col-transition">
                                    <div class="inner1">
                                        <h2>Silver WordPress Package</h2>
                                    </div>
                                    <div class="inner2">
                                        <h2>$1949 <span>$3199.00</span></h2>
                                        <button class="btns" href="javascript:;" data-bs-toggle="modal" data-bs-target="#contactModal">View Detail</button>
